...
from tkinter import CENTER, font as tkfont
...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            label = tk.Label(self, text="    Welcome To Face Recognition Based Banking System      ", font=self.controller.title_font,fg="#263942")
            label.grid(row=0, sticky="ew")
            button1 = tk.Button(self, text="   Create a User  ",fg="white", bg="navy blue",command=lambda: self.controller.show_frame("PageOne"))
            button2 = tk.Button(self, text="   Check a User  ", fg="white", bg="navy blue",command=lambda: self.controller.show_frame("PageTwo"))
            button3 = tk.Button(self, text="Quit", fg="white", bg="red", command=self.on_closing)
...
class PageOne(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent)
        self.controller = controller
        tk.Label(self, text="Enter the name", fg="#263942", font='Helvetica 24 bold').grid(row=0, column=0, pady=10, padx=5)
...
class PageThree(tk.Frame):
    ...
    def trainmodel(self):
        ...
        messagebox.showinfo("SUCCESS", "The face has been successfully trained!")
        self.controller.show_frame("PageFour")
